...
class UtentiApi {
  ...
  /// Parameters:
  /// * [id] - ID dell'utente
  /// * [idSegnalazione] - ID della segnalazione
  ...
  Future<Response<SegnalazioneOutput>> getSegnalazioneById({ 
    ...
    SegnalazioneOutput? _responseData;
    ...
    return Response<SegnalazioneOutput>(
      data: _responseData,
  ...
  Future<Response<BuiltList<SegnalazioneOutput>>> getSegnalazioniByUserId({ 
    ...
    BuiltList<SegnalazioneOutput>? _responseData;
    ...
    return Response<BuiltList<SegnalazioneOutput>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UtenteDettaglioOutput>> getUserById({ 
    ...
    UtenteDettaglioOutput? _responseData;
    ...
    return Response<UtenteDettaglioOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
